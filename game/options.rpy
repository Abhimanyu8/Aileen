...
init -1 python hide:
    ...
    config.window_title = u"Aileen - Artificial Intelligence & Ren'Py"
...
python early:
    config.save_directory = "Aileen-1448222652"
...
init python:
    ...
    build.directory_name = "Aileen-1.1"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "Aileen"
